...
###This script will be used to test your RC4 encryption. If you are coding in perl, an appropriate script will be used.
###Author - Bharath Kumar Comandur
###	    Purdue University
	    

###Note - You need to change the script appropriately to make it executable. This is just to help you write your scripts in a suitable syntax


import wave 

from abahrain_hw5 import *
...
#the following command reads and returns at most nframe_original frames of audio, as a string of bytes.
originalAudio = originalp1.readframes(nframe_original)

#define your rc4Cipher.encrypt and decrypt functions appropriately
#obviously the encryptedAudio and decryptedAudio will be also be strings of bytes , just like originalAudio
